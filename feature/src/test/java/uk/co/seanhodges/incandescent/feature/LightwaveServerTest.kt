...
class LightwaveServerTest {
    ...
    fun testAuthenticatesAndGetsAccessToken() {
        val accessToken : String = server.authenticate("seanhodges84@gmail.com", "Do4lovedo4love")
        println(accessToken)
    }
    ...
    companion object {
        ...
        private val ROOT_GROUP_ID = "5b8aa9b4d36c330fd5b4e100-5b8aa9b4d36c330fd5b4e101"
        private val FEATURE_ID = "5b8aa9b4d36c330fd5b4e100-23-3157332334+1"
        private val FEATURE_DIM_VALUE = 20
    }
